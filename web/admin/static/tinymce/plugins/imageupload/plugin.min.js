                        ...
                        <div class="imageUploadContainerInner">\
                            ...
                            <div class="mce-container imageUploadFormContainer" hidefocus="1" tabindex="-1">\
                                <div class="mce-container-body" style="padding-left: 20px;">\
                                    ...
                                    <input type="file" name="image_file" id="image-upload-area" class="mce-textbox mce-placeholder" hidefocus="true" style="width: 258px;" accept="image/*">\
                                </div>\
                            ...
                            <div class="imageUploadConfirmCase mce-panel">\
                                <div class="mce-btn mce-primary">\
                                    <button role="presentation" class="imageUploadSubmit">确定</button>\
                                </div>\
                                <div class="mce-btn">\
                                    <button role="presentation" class="imageUploadClose">取消</button>\
                                </div>\
                            </div>\
                        </div>\
                    </div>\
                    ...
                    $('#uploadImageForm').ajaxSubmit({
                        ...
                        success: function(response){
                            if (response.code == 0) {
                                ...
                                var tplV = tpl.replace('%s', response.content.url);
