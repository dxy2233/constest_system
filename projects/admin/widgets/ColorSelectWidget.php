...
use yii\web\View;
use admin\widgets\kartik\Html5Input;
use admin\widgets\kartik\Html5InputAsset;
 ...
 */
class ColorSelectWidget extends Html5Input
{
    ...
    public function registerColorInput()
    {
        ...
        $view->registerJsFile('/static/colorSelect/spectrum.min.js');
        $view->registerCssFile('/static/colorSelect/spectrum.min.css');
        $view->registerJsFile('/static/colorSelect/spectrum-kv.min.js');
        $view->registerCssFile('/static/colorSelect/spectrum-kv.min.css');
