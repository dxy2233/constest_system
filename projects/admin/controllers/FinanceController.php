...
class FinanceController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        if ($order != '') {
            $order_arr = [1 => 'A.currency_id', 2 => 'A.position_amount', 4 => 'A.frozen_amount', 3 => 'A.use_amount', 5 => 'A.currency_id desc', 6 => 'A.position_amount desc', 8 => 'A.frozen_amount desc', 7 => 'A.use_amount desc'];
