...
namespace admin\gii\adminlte\business;
...
{
    public $db = 'db';
    public $ns = 'common\models\business';
    public $tableName;
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['ns','modelClass'], 'filter', 'filter' => 'trim'],
            [['ns','modelClass','businessName'], 'required'],
        ]);
    }
    ...
    public function generate()
    {
        ...
        $db = $this->getDbConnection();
            $modelClassName = $this->businessName;
            ...
            $files[] = new CodeFile(
                Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/' . $this->businessName . '.php',
