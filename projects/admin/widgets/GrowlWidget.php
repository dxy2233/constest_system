...
use admin\widgets\kartik\AnimateAsset;
use admin\widgets\kartik\Widget;
 ...
 * @since 1.0
 */
class GrowlWidget extends Widget
{
    ...
    protected function registerAssets()
    {
        ...
        if (in_array($this->type, self::$_themes)) {
            ...
            $view->registerCssFile('/static/growl/kv-bootstrap-notify.min.css');
            $view->registerJsFile('/static/growl/bootstrap-notify.min.js');
            $view->registerCssFile("/static/growl/{$this->type}.min.css");
