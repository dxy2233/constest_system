...
<head>
    ...
    <link href="https://cdn.bootcss.com/semantic-ui/2.1.6/components/table.min.css" rel="stylesheet">
    <link href="https://cdn.bootcss.com/semantic-ui/2.1.6/components/container.min.css" rel="stylesheet">
    <link href="https://cdn.bootcss.com/semantic-ui/2.1.6/components/message.min.css" rel="stylesheet">
    <link href="https://cdn.bootcss.com/semantic-ui/2.1.6/components/label.min.css" rel="stylesheet">
   <!-- <link rel="stylesheet" href="https://staticfile.qnssl.com/semantic-ui/2.1.6/semantic.min.css">
    ...
    <style>
        /* 布局 */
        .site-tree, .site-content,.site-right {
                ...
                <?php else: ?>
                    <div class="ui raised segment">
                        ...
                        <table class="ui blue celled striped table">
                            ...
                            <tbody>
                            <?php  $showParam= []; foreach ($item['response'] as $param):
                                if(in_array($param[1],$showParam))continue;
                                ...
                                <tr>
                                    ...
                                    <td><?= $param[0] ?></td>
                                    <td>
                                    <?php if($param[0] == 'array'):
                                        $str = '';
                                        foreach ($item['response'] as $i){
                                        $showParam[]=$param[1];
                                        if($i[1] === $param[1]){
                                            $str .= '<br/>'.$i[2];
                                        }
                        ...
                        <div class="ui existing segment" >
                            <a class="ui teal image label">
                                数据示例：
                                <div class="detail">json格式</div>
                            </a>

                            <div class="ui warning ignored message">
                              <pre>
                            <code class="nginx hljs">
<?=$item['example']?>
                            </code>
                            </pre>
                            </div>
    ...
    <div class="ui dividing right rail" style="min-height: 1135px;">
        <div class="ui sticky fixed top" style="right:120px; !important; height: 1135px
        !important; margin-top: 30px;">
            <div style="min-height: 735px;">
            ...
            <button class="ui circular facebook icon button" id="totop">
                <i class="icon">顶</i>
            </button>
