...
namespace admin\widgets\kartik;
...
class TypeaheadBasic extends InputWidget
{
    ...
    public function registerAssets()
    {
        ...
        $view->registerJsFile('/static/typeaHead/typeahead.jquery.mian.js');
        $view->registerJsFile('/static/typeaHead/typeahead-kv.mian.js');
        $view->registerCssFile('/static/typeaHead/typeahead.mian.css');
        $view->registerCssFile('/static/typeaHead/typeahead-kv.mian.css');
