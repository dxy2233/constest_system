<div class="form-group">
    ...
    <div class="col-lg-<?php echo $this->context->contentLen; ?>">
        <div style="padding-left:0px;">
            <iframe frameborder="0" src="/uploader/default/image-template?context=<?php echo $this->context->context;?>&callback=uploadProject_<?php echo $this->context->id;?>&localImage=true&hasImage<?=$this->context->imageUrl?true:false;?>" width="400px" height="50px" style="border: 0px;" scrolling="no"></iframe>
