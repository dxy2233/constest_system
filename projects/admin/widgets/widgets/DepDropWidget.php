...
use admin\widgets\kartik\Config;
use admin\widgets\SelectWidget;
 ...
 * @since 1.0.4
 */
class DepDropWidget extends InputWidget
{
...
//        }
    ...
    public function registerAssets()
    {
        ...
        if ($this->type === self::TYPE_SELECT2) {
            ...
            $this->select2PluginOptions = $this->pluginOptions;
            if ($this->hasModel()) {
            ...
            $settings['pluginOptions'] = $this->select2PluginOptions;
            echo SelectWidget::widget($settings);
            $id = $this->options['id'];
