...
use yii\web\View;
use admin\widgets\kartik\TypeaheadBasic;
/**
 ...
 */
class TypeaheadWidget extends TypeaheadBasic
{
    /**
    ...
    {
        $view = $this->getView();
        $view->registerJsFile('/static/typeaHead/typeahead-kv.min.js');
        $view->registerJsFile('/static/typeaHead/typeahead.bundle.min.js');
        $view->registerCssFile('/static/typeaHead/typeahead-kv.min.css');
        $view->registerCssFile('/static/typeaHead/typeahead.min.css');
        if ($this->useHandleBars) {
            $view->registerJsFile('/static/typeaHead/handlebars.min.js');
        }
